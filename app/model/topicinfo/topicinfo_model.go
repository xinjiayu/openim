...
// arModel is a active record design model for table topicinfo operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of topicinfo.
	Table = "topicinfo"
	// Model is the model object of topicinfo.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table topicinfo.
	Columns = struct {
		Num      string //
		Sendtime string //
		Topic    string //
