...
// arModel is a active record design model for table history operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of history.
	Table = "history"
	// Model is the model object of history.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table history.
	Columns = struct {
		Topic    string //
		Froma    string //
		Data     string //
